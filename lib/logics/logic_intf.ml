...
module type S = sig
  ...
  module Model : Model_intf.S with type transition = transition
  module Formula : Formula_intf.S with type modality = modality

  module Formula_ast :
    Naive_modcheck_coalg_parsers.Formula.Ast.S with type modality = modality
